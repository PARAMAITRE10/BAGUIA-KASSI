...
export default function Conection() {
   ...
   const[utilisateurs, setutilisateurs]= React.useState([]);
    ...
    const onSubmit=(data)=> {
        console.log(data);
       axios.get("http://localhost:3000/factures",data).then((res)=>{
...
>AFFICHER LISTES</Button>   <Button variant="contained" sx={{
...
>
    ...
    <Typography>{publicatio.refProduit} </Typography>
    <Typography>{publicatio.NomProduit}</Typography>
   </Stack>
